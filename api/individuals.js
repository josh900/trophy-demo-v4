...
export default async function handler(req, res) {
    ...
    const apiUrl = 'https://budibase.skoop.digital/api/public/v1/queries/query_datasource_plus_56025c99333e46b8a073e70585159c4c_f62962e3b6ff47e690977d49cd6d6165';
    const headers = {
    ...
    try {
      ...
      res.status(500).json({ error: 'Failed to fetch individuals data' });
    }
  }